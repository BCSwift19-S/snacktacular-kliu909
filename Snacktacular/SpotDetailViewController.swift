...
class SpotDetailViewController: UIViewController {
    ...
    var reviews: Reviews!
    var photos: Photos!
    let regionDistance: CLLocationDistance = 750 // 750 meters or about half mile
...
extension SpotDetailViewController: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .restricted:
            print("Access denied. Likely parental controls are restircting location services in this app.")
        }
